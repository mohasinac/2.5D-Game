...
|-----------|----------|-----------|-------|
| Shark Edge Blade | 34.5 [INFERRED] | 1.031×10⁻⁵ | 93.2% |
| Ratchet | 7.0 [INFERRED] | 7.42×10⁻⁷ | 6.71% |
| Bit | 4.0 | 4.5×10⁻⁹ | 0.04% |
...
Compare to tip friction alone (attack Bit, μ = 0.45, r_tip = 4 mm, m_total = 0.0455 kg):
  ...
  Blended rate (20% contact, 80% tip-only) [INFERENCE]:
...
| Dran Dagger  | 35.3 [INFERRED] | 1.031×10⁻⁵     | −10.05        |  69.7       |
...
Weight contribution to spin decay (2.3 g [CONFIRMED] Flat Bit vs 2.1 g [CONFIRMED] Ball Bit):
...
Accel m_bit=2.6 g vs Flat m_bit=2.3 g [CONFIRMED]; extra 0.3 g at r≈4mm from axis:
...
Extra disc mass Δm≈1.1 g (3.2 − 2.1 [CONFIRMED] = 1.1 g vs Ball) at r_disc≈7.5 mm:
