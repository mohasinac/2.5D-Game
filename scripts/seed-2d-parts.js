...
const parts = {
  ...
  tip_parts: [
    ...
    base({
      id: "f-d",
      displayName: "F:D (Flat / Defense)",
      description:
        "Dual-mode tip — flat at high spin for aggressive attack, retracts to defense point at low spin for LAD stamina. Mode switch at ~35% spin (94.3 rad/s confirmed).",
      rarity: "rare",
      friction: 0.6,
      tipShape: "flat",
      material: "abs",
      ...
      images: { thumbnail: SVG.flat },
      geometry: { type: "preset", preset: "cylinder" },
      dimensions: { height: 10, outerRadius: 12, innerRadius: 0 },
      compatibilityTags: ["balanced", "mode-switch", "attack-stamina"],
      configurations: [
        {
          name: "flat-mode",
          displayName: "Flat (High Spin)",
          description: "Wide flat — aggressive orbital movement.",
          playerSwitchable: false,
          overrides: { tipShape: "flat", gripFactor: 0.6, aggressiveness: 0.85 },
          autoTriggers: [{ type: "spin_threshold", threshold: 1.0 }],
        },
        {
          name: "defense-mode",
          displayName: "Defense (Low Spin)",
          description: "Narrow defense point — stationary stamina conservation.",
          playerSwitchable: false,
          overrides: { tipShape: "defense", gripFactor: 0.15, aggressiveness: 0.1 },
          autoTriggers: [{ type: "spin_threshold", threshold: 0.35 }],
        },
      ],
    }),
    base({
      id: "mc",
      displayName: "Metal Change (MC)",
      description:
        "Metal sharp tip with spring-loaded mode change — sharp at high spin for stamina, widens at medium spin for aggressive movement.",
      rarity: "rare",
      friction: 0.3,
      tipShape: "sharp",
      material: "metal",
      ...
      geometry: { type: "preset", preset: "cone" },
      dimensions: { height: 12, outerRadius: 6, innerRadius: 0 },
      compatibilityTags: ["stamina", "mode-switch", "metal"],
      configurations: [
        {
          name: "sharp-mode",
          displayName: "Sharp (High Spin)",
          description: "Metal point — near-stationary stamina.",
          playerSwitchable: false,
          overrides: { tipShape: "sharp", gripFactor: 0.12, aggressiveness: 0.3 },
          autoTriggers: [{ type: "spin_threshold", threshold: 1.0 }],
        },
        {
          name: "wide-mode",
          displayName: "Wide (Low Spin)",
          description: "Wider semi-flat contact — more aggressive movement.",
          playerSwitchable: false,
          overrides: { tipShape: "semi_flat", gripFactor: 0.25, aggressiveness: 0.5 },
          autoTriggers: [{ type: "spin_threshold", threshold: 0.5 }],
        },
      ],
    }),
    base({
      id: "rsf",
      displayName: "RSF (Rubber Semi-Flat)",
      description:
        "Flat rubber center with curved outer rim. More aggressive on bowl slopes as curved area contacts more surface. Slope-reactive grip via spline height profile.",
      rarity: "rare",
      friction: 0.85,
      tipShape: "rubber_flat",
      material: "rubber",
      ...
      images: { thumbnail: SVG.rubberFlat },
      geometry: { type: "preset", preset: "cylinder-rounded" },
      dimensions: { height: 8, outerRadius: 14, innerRadius: 0 },
      compatibilityTags: ["attack", "rubber", "slope-reactive"],
      heightProfile: {
        type: "spline",
        splineKnots: [
          { radius: 0, height: 0 },
