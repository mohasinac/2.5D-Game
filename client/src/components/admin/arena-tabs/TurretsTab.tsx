...
function TypeSpecificParams({ turret, update }: { turret: TurretConfig; update: (field: keyof TurretConfig, value: any) => void }) {
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div>
        <div className="flex justify-between text-[11px] text-faint mb-0.5">
          ...
          <span className="text-text font-mono">{turret.bulletSpeed ?? 200}</span>
        </div>
      ...
      <div>
        <div className="flex justify-between text-[11px] text-faint mb-0.5">
          ...
          <span className="text-text font-mono">{turret.bulletCount ?? 1}</span>
        </div>
  ...
  if (t === "beam") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Beam Duration (s)</label>
        {numInput(turret.beamDuration, 3, v => update("beamDuration", v), 0.5)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Charge Period (s)</label>
  ...
  if (t === "aoe") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>AoE Radius (cm)</label>
        {cmNumInput(turret.aoeRadius, 80, v => update("aoeRadius", v), 10)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Damage Radius (cm)</label>
  ...
  if (t === "boomerang") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Return Time (s)</label>
  ...
  if (t === "laser_sweep") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Sweep Arc (°)</label>
        {numInput(turret.laserSweepArcDeg, 180, v => update("laserSweepArcDeg", v), 10)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Sweep Speed (°/s)</label>
  ...
  if (t === "sniper") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Charge Time (s)</label>
      {numInput(turret.sniperChargeSec, 2, v => update("sniperChargeSec", v), 0.5)}
    </div>
  );
  if (t === "shotgun") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Cone Half-Angle (°)</label>
  ...
  if (t === "mine_layer") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 85 }}>Trigger Radius (cm)</label>
        {cmNumInput(turret.mineTriggerRadius, 50, v => update("mineTriggerRadius", v), 5)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 85 }}>Lifetime (s, 0=∞)</label>
  ...
  if (t === "gravity_cannon") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Force (N)</label>
        {numInput(turret.gravityCannonForce, 0.01, v => update("gravityCannonForce", v), 0.001)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Duration (s)</label>
  ...
  if (t === "emp") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Disable Ticks</label>
      {numInput(turret.empDisableTicks, 120, v => update("empDisableTicks", Math.round(v)), 10)}
    </div>
  );
  if (t === "tracking_missile") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Tracking (°/s)</label>
  ...
  if (t === "burst_fire") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Burst Count</label>
        {numInput(turret.burstCount, 4, v => update("burstCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Interval (s)</label>
        {numInput(turret.burstIntervalSec, 0.15, v => update("burstIntervalSec", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Reload (s)</label>
  ...
  if (t === "plasma_ring") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Expand Speed (px/s)</label>
        {numInput(turret.plasmaRingExpandSpeed, 150, v => update("plasmaRingExpandSpeed", v), 10)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Max Radius (cm)</label>
  ...
  if (t === "tractor_beam") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Pull Force (N)</label>
  ...
  if (t === "surf") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Wave Width (cm)</label>
        {cmNumInput(turret.surfWaveWidthPx, 120, v => update("surfWaveWidthPx", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Wave Speed (px/s)</label>
        {numInput(turret.surfWaveSpeedPx, 400, v => update("surfWaveSpeedPx", v), 20)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Slow Mult</label>
  ...
  if (t === "hydro_pump") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Knockback</label>
        {numInput(turret.hydroPumpKnockback, 0.08, v => update("hydroPumpKnockback", v), 0.005)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Slow Duration (s)</label>
  ...
  if (t === "fire_spin") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Ring Radius (cm)</label>
        {cmNumInput(turret.fireSpinRadiusPx, 60, v => update("fireSpinRadiusPx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Duration (s)</label>
        {numInput(turret.fireSpinDurationSec, 3, v => update("fireSpinDurationSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Spin Drain/s</label>
  ...
  if (t === "thunderbolt") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Stun Duration (s)</label>
  ...
  if (t === "psychic") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Cycle (s)</label>
        {numInput(turret.psychicCycleIntervalSec, 2, v => update("psychicCycleIntervalSec", v), 0.25)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Force (N)</label>
  ...
  if (t === "gust") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Wind Angle (°)</label>
  ...
  if (t === "shadow_ball") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 85 }}>Speed (px/s)</label>
        {numInput(turret.shadowBallSpeedPx, 180, v => update("shadowBallSpeedPx", v), 10)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 85 }}>Fragments</label>
  ...
  if (t === "fire_blast") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 50 }}>Petals</label>
        {numInput(turret.fireBlastPetals, 5, v => update("fireBlastPetals", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Burn/s</label>
        {numInput(turret.fireBlastBurnPerSec, 8, v => update("fireBlastBurnPerSec", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Burn Dur (s)</label>
  ...
  if (t === "sludge_bomb") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Zone Radius (cm)</label>
        {cmNumInput(turret.sludgeBombRadiusPx, 70, v => update("sludgeBombRadiusPx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Lifetime (s)</label>
  ...
  if (t === "toxic_spikes") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Spike Count</label>
        {numInput(turret.toxicSpikeCount, 4, v => update("toxicSpikeCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Trigger (cm)</label>
        {cmNumInput(turret.toxicSpikeTriggerPx, 30, v => update("toxicSpikeTriggerPx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Poison/s</label>
  ...
  if (t === "roar") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Scramble Duration (s)</label>
  ...
  if (t === "multi_missile") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Missile Count</label>
        {numInput(turret.multiMissileCount, 3, v => update("multiMissileCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Spread Delay (s)</label>
  ...
  if (t === "blizzard") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Cone Half (°)</label>
        {numInput(turret.blizzardConeHalfDeg, 50, v => update("blizzardConeHalfDeg", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Freeze (s)</label>
        {numInput(turret.blizzardFreezeDurationSec, 2, v => update("blizzardFreezeDurationSec", v), 0.25)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Ice Patch (s)</label>
        {numInput(turret.blizzardIcePatchDurationSec, 4, v => update("blizzardIcePatchDurationSec", v), 0.5)}
      </div>
      <label className="flex gap-1.5 items-center text-[11px] text-faint" style={{ gridColumn: "span 3" }}>
  ...
  if (t === "earthquake") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Wave Count</label>
        {numInput(turret.earthquakeWaves, 3, v => update("earthquakeWaves", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Wave Interval (s)</label>
  ...
  if (t === "flamethrower") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Beam Width (cm)</label>
        {cmNumInput(turret.flamethrowerBeamWidthPx, 15, v => update("flamethrowerBeamWidthPx", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Burn/s</label>
        {numInput(turret.flamethrowerBurnPerSec, 8, v => update("flamethrowerBurnPerSec", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Burn Dur (s)</label>
  ...
  if (t === "ice_beam") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Freeze (s)</label>
        {numInput(turret.iceBeamFreezeDurationSec, 2, v => update("iceBeamFreezeDurationSec", v), 0.25)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Spin Drain/s</label>
  ...
  if (t === "dragon_breath") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Stagger %</label>
        {numInput((turret.dragonBreathStaggerChance ?? 0.35) * 100, 35, v => update("dragonBreathStaggerChance", v / 100), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Stagger (s)</label>
  ...
  if (t === "confuse_ray") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Confusion (s)</label>
  ...
  if (t === "leech_seed") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>HP Drain/s</label>
        {numInput(turret.leechSeedHealthPerSec, 5, v => update("leechSeedHealthPerSec", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Spin Drain/s</label>
  ...
  if (t === "vine_whip") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Grip (s)</label>
        {numInput(turret.vineWhipGripDurationSec, 2, v => update("vineWhipGripDurationSec", v), 0.25)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Pull Force (N)</label>
  ...
  if (t === "sticky_web") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Radius (cm)</label>
  ...
  if (t === "hyper_beam") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Charge (s)</label>
        {numInput(turret.hyperBeamChargeSec, 4, v => update("hyperBeamChargeSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Recharge (s)</label>
  ...
  if (t === "gravity_field") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Duration (s)</label>
  ...
  if (t === "sand_tomb") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Pushback (N)</label>
  ...
  if (t === "zap_cannon") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Speed (px/s)</label>
        {numInput(turret.zapCannonSpeedPx, 100, v => update("zapCannonSpeedPx", v), 10)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Paralysis (s)</label>
  ...
  if (t === "overheat") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Dmg Mult</label>
        {numInput(turret.overheatDamageMult, 3.0, v => update("overheatDamageMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>CD Mult</label>
        {numInput(turret.overheatCooldownMult, 3.0, v => update("overheatCooldownMult", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Penalty Shots</label>
  ...
  if (t === "chain_lightning") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Jumps</label>
        {numInput(turret.chainLightningJumps, 3, v => update("chainLightningJumps", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Dmg Decay</label>
        {numInput((turret.chainLightningDecay ?? 0.5) * 100, 50, v => update("chainLightningDecay", v / 100), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Stun (s)</label>
  ...
  if (t === "spore") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Radius (cm)</label>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Drain Mult</label>
        {numInput(turret.sporeSpinDrainMult, 2.0, v => update("sporeSpinDrainMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Sleep (s)</label>
  ...
  if (t === "dark_void") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Void Count</label>
        {numInput(turret.darkVoidCount, 3, v => update("darkVoidCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Speed (px/s)</label>
  ...
  if (t === "rock_slide") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Boulders</label>
        {numInput(turret.rockSlideBoulderCount, 5, v => update("rockSlideBoulderCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Scatter (cm)</label>
        {cmNumInput(turret.rockSlideScatterPx, 120, v => update("rockSlideScatterPx", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>AoE (cm)</label>
  ...
  if (t === "whirlpool") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Orbit Force</label>
  ...
  if (t === "stealth_rock") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Count</label>
        {numInput(turret.stealthRockCount, 6, v => update("stealthRockCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Radius (cm)</label>
        {cmNumInput(turret.stealthRockRadiusPx, 40, v => update("stealthRockRadiusPx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Dmg/s</label>
        {numInput(turret.stealthRockDmgPerSec, 4, v => update("stealthRockDmgPerSec", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Lifetime (s)</label>
  ...
  if (t === "ember") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Burn Ticks</label>
        {numInput(turret.emberBurnTicks, 3, v => update("emberBurnTicks", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Tick Dmg</label>
        {numInput(turret.emberBurnTickDmg, 5, v => update("emberBurnTickDmg", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Interval (s)</label>
  ...
  if (t === "magma_storm") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Ring Width (cm)</label>
        {cmNumInput(turret.magmaStormRingWidthPx, 24, v => update("magmaStormRingWidthPx", v), 2)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Rotation (°/s)</label>
  ...
  if (t === "eruption") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Geyser AoE (cm)</label>
        {cmNumInput(turret.eruptionGeyserAoePx, 80, v => update("eruptionGeyserAoePx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Extra Dmg/Bey</label>
  ...
  if (t === "bubble_beam") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Bubbles</label>
        {numInput(turret.bubbleBeamCount, 3, v => update("bubbleBeamCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Slow Mult</label>
        {numInput(turret.bubbleBeamSlowMult, 0.65, v => update("bubbleBeamSlowMult", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Slow Dur (s)</label>
  ...
  if (t === "aqua_ring") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Duration (s)</label>
  ...
  if (t === "origin_pulse") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Wave Count</label>
        {numInput(turret.originPulseWaveCount, 2, v => update("originPulseWaveCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Push Force</label>
  ...
  if (t === "icicle_spear") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Spears</label>
        {numInput(turret.icicleSpearCount, 5, v => update("icicleSpearCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Interval (ms)</label>
  ...
  if (t === "hail") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 50 }}>Chunks</label>
        {numInput(turret.hailChunkCount, 6, v => update("hailChunkCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Scatter (cm)</label>
        {cmNumInput(turret.hailScatterRadiusPx, 100, v => update("hailScatterRadiusPx", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>AoE (cm)</label>
  ...
  if (t === "glacial_lance") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Width (cm)</label>
        {cmNumInput(turret.glacialLanceWidthPx, 60, v => update("glacialLanceWidthPx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Freeze (s)</label>
  ...
  if (t === "thunder_wave") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Speed Mult</label>
  ...
  if (t === "bolt_strike") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Bolts</label>
        {numInput(turret.boltStrikeBolts, 1, v => update("boltStrikeBolts", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Paralysis (s)</label>
  ...
  if (t === "air_slash") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Flinch Chance</label>
        {numInput(turret.airSlashFlinchChance, 0.3, v => update("airSlashFlinchChance", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Flinch (s)</label>
  ...
  if (t === "hurricane") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Speed (px/s)</label>
        {numInput(turret.hurricaneSpeedPx, 200, v => update("hurricaneSpeedPx", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Zone (s)</label>
  ...
  if (t === "aeroblast") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Beam Width (cm)</label>
        {cmNumInput(turret.aeroblastBeamWidthPx, 50, v => update("aeroblastBeamWidthPx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Push Force</label>
  ...
  if (t === "stone_edge") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 50 }}>Shards</label>
        {numInput(turret.stoneEdgeShards, 3, v => update("stoneEdgeShards", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Crit Chance</label>
        {numInput(turret.stoneEdgeCritChance, 0.5, v => update("stoneEdgeCritChance", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Crit Mult</label>
  ...
  if (t === "dig") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Delay (ms)</label>
        {numInput(turret.digDelayMs, 800, v => update("digDelayMs", v), 50)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Surface AoE (cm)</label>
  ...
  if (t === "tectonic_rage") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Fissures</label>
        {numInput(turret.tectonicRageFissures, 4, v => update("tectonicRageFissures", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Width (cm)</label>
  ...
  if (t === "flash_cannon") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 100 }}>Beam Dur (s)</label>
  ...
  if (t === "bullet_punch") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 50 }}>Hits</label>
  ...
  if (t === "steel_surge") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Dmg/Tick</label>
  ...
  if (t === "absorb") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>HP Drain/s</label>
  ...
  if (t === "petal_dance") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Petals</label>
  ...
  if (t === "bloom_doom") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Absorb (s)</label>
        {numInput(turret.bloomDoomAbsorbSec, 2, v => update("bloomDoomAbsorbSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Burst Force Mult</label>
  ...
  if (t === "night_shade") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>HP Fraction</label>
  ...
  if (t === "phantom_force") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Dmg/s</label>
  ...
  if (t === "flash") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Blind (s)</label>
  ...
  if (t === "solar_beam") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Charge (s)</label>
  ...
  if (t === "solar_flare") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Blind (s)</label>
        {numInput(turret.solarFlareBlindSec, 3, v => update("solarFlareBlindSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Flat Dmg</label>
  ...
  if (t === "spark") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Wet Dmg Mult</label>
  ...
  if (t === "magnetic_field") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Orbit Force</label>
  ...
  if (t === "thunder_storm") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Strike Int (s)</label>
        {numInput(turret.thunderStormStrikeIntervalSec, 1.5, v => update("thunderStormStrikeIntervalSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Strike Dmg</label>
  ...
  if (t === "distortion") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Teleport Radius (cm)</label>
  ...
  if (t === "black_hole_shot") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Pull Force</label>
  ...
  if (t === "spacial_rend") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Damage</label>
        {numInput(turret.spacialRendDamage, 50, v => update("spacialRendDamage", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Scatter Radius (cm)</label>
  ...
  if (t === "cross_slash") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Range (cm)</label>
        {cmNumInput(turret.crossSlashRangePx, 80, v => update("crossSlashRangePx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Bonus Mult</label>
  ...
  if (t === "impact_burst") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Knockback</label>
        {numInput(turret.impactBurstKnockback, 0.07, v => update("impactBurstKnockback", v), 0.005)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Confusion (s)</label>
  ...
  if (t === "armor_pierce") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Shatter Dur (s)</label>
  ...
  if (t === "flurry_barrage") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 50 }}>Shots</label>
        {numInput(turret.flurryBarrageHits, 5, v => update("flurryBarrageHits", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Escalate Mult</label>
        {numInput(turret.flurryBarrageEscalateMult, 0.3, v => update("flurryBarrageEscalateMult", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Interval (ms)</label>
  ...
  if (t === "mach_shot") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 100 }}>Speed Mult</label>
  ...
  if (t === "gravity_grip") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Hold (s)</label>
        {numInput(turret.gravityGripHoldSec, 2, v => update("gravityGripHoldSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Spin Drain/s</label>
  ...
  if (t === "ram_charge") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Stun Chance</label>
        {numInput(turret.ramChargeStunChance, 0.3, v => update("ramChargeStunChance", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Stun (s)</label>
  ...
  if (t === "graviton_throw") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Push Force</label>
  ...
  if (t === "razor_spin") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Dmg/s</label>
  ...
  if (t === "point_blank") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Max Range (cm)</label>
        {cmNumInput(turret.pointBlankRangePx, 60, v => update("pointBlankRangePx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Dmg Mult</label>
  ...
  if (t === "static_field") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Shock Dmg</label>
        {numInput(turret.staticFieldShockDmg, 15, v => update("staticFieldShockDmg", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Cooldown (ms)</label>
  ...
  if (t === "acid_spray") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Def Break Mult</label>
        {numInput(turret.acidSprayDefBreakMult, 1.5, v => update("acidSprayDefBreakMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Debuff (s)</label>
  ...
  if (t === "spin_slash") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 50 }}>Arms</label>
        {numInput(turret.spinSlashArms, 3, v => update("spinSlashArms", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Speed (°/s)</label>
  ...
  if (t === "guillotine") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Spin Threshold</label>
  ...
  if (t === "anti_grav") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Airborne (s)</label>
        {numInput(turret.antiGravAirborneSec, 1.5, v => update("antiGravAirborneSec", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Slam AoE (cm)</label>
        {cmNumInput(turret.antiGravSlamAoePx, 70, v => update("antiGravSlamAoePx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Slam Dmg</label>
  ...
  if (t === "drain_sting") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Steal Fraction</label>
  ...
  if (t === "sting_bolt") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Crit Chance</label>
        {numInput(turret.stingBoltCritChance, 0.3, v => update("stingBoltCritChance", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Crit Mult</label>
  ...
  if (t === "dark_pulse") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Stagger (s)</label>
        {numInput(turret.darkPulseStaggerSec, 1.0, v => update("darkPulseStaggerSec", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Spin Drain %</label>
  ...
  if (t === "steel_ram") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Stun (s)</label>
  ...
  if (t === "metal_sound") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Def Break Mult</label>
  ...
  if (t === "magnet_bomb") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Pull (s)</label>
        {numInput(turret.magnetBombPullSec, 1.0, v => update("magnetBombPullSec", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Explosion (cm)</label>
  ...
  if (t === "drill_shot") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Pierce (cm)</label>
  ...
  if (t === "hyper_voice") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Stagger (s)</label>
  ...
  if (t === "swords_dance") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Charges</label>
        {numInput(turret.swordsDanceCharges, 3, v => update("swordsDanceCharges", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Dmg Mult</label>
  ...
  if (t === "tail_whip") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Dmg Taken Mult</label>
  ...
  if (t === "growl") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Spin Drain Mult</label>
  ...
  if (t === "meditate") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Dmg Mult</label>
      {numInput(turret.meditateMult, 4.0, v => update("meditateMult", v), 0.5)}
    </div>
  );
  if (t === "nasty_plot") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Bypass Shots</label>
  ...
  if (t === "agility") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Cooldown Mult</label>
  ...
  if (t === "poison_jab") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Stacks</label>
        {numInput(turret.poisonJabStacks, 1, v => update("poisonJabStacks", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>DoT/s/Stack</label>
        {numInput(turret.poisonJabDotPerSec, 5, v => update("poisonJabDotPerSec", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>DoT Dur (s)</label>
  ...
  if (t === "future_sight") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Delay (s)</label>
  ...
  if (t === "dragon_slash") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Stagger Chance</label>
  ...
  if (t === "outrage") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Rampage (s)</label>
        {numInput(turret.outrageRampageSec, 3.0, v => update("outrageRampageSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Recoil (s)</label>
        {numInput(turret.outrageRecoilSec, 2.0, v => update("outrageRecoilSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Hit Int (ms)</label>
  ...
  if (t === "hex") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Status Mult</label>
      {numInput(turret.hexStatusMult, 2.0, v => update("hexStatusMult", v), 0.1)}
    </div>
  );
  if (t === "ghost_strike") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 100 }}>Max Range (cm)</label>
  ...
  if (t === "dazzling_gleam") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Lock (s)</label>
  ...
  if (t === "charge") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 85 }}>Paralysis Chance</label>
  ...
  if (t === "skull_bash") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Charge (s)</label>
        {numInput(turret.chargeCannonChargeSec, 1.5, v => update("chargeCannonChargeSec", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Knockdown (s)</label>
  ...
  if (t === "flare_blitz") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Recoil Frac</label>
        {numInput(turret.flareBlitzRecoilFraction, 0.33, v => update("flareBlitzRecoilFraction", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Burn (s)</label>
  ...
  if (t === "uppercut") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Airborne (s)</label>
  ...
  if (t === "launch_spike") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>Spike AoE (cm)</label>
  ...
  if (t === "spear_chain") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Pull Force</label>
  ...
  if (t === "cryo_lance") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Shatter Mult</label>
  ...
  if (t === "ring_blade") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Passes</label>
  ...
  if (t === "portal_strike") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Burst Radius (cm)</label>
  ...
  if (t === "dragon_fireball") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Bounces</label>
  ...
  if (t === "inferno_slam") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 90 }}>AoE (cm)</label>
  ...
  if (t === "harden") return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 110 }}>Invuln Duration (s)</label>
  ...
  if (t === "defense_curl") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Invuln (s)</label>
        {numInput(turret.defenseCurlDurationSec, 1.0, v => update("defenseCurlDurationSec", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Next Shot Mult</label>
  ...
  if (t === "enlarge") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Radius Scale</label>
        {numInput(turret.enlargeRadiusScale, 1.5, v => update("enlargeRadiusScale", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Collision Mult</label>
        {numInput(turret.enlargeCollisionMult, 1.8, v => update("enlargeCollisionMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Speed Mult</label>
  ...
  if (t === "mass_shift") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>KB Resist</label>
        {numInput(turret.massShiftKbResist, 0.6, v => update("massShiftKbResist", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Collision Mult</label>
  ...
  if (t === "density_crush") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>AoE Radius</label>
  ...
  if (t === "hollow_transform") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Cero Dmg</label>
        {numInput(turret.hollowTransformCeroDmg, 40, v => update("hollowTransformCeroDmg", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Pulse (ms)</label>
  ...
  if (t === "kyuubi_mode") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Aura Radius</label>
        {numInput(turret.kyuubiModeAuraRadius, 100, v => update("kyuubiModeAuraRadius", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>DPS</label>
  ...
  if (t === "bijuu_mode") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>AoE Radius</label>
        {numInput(turret.bijuuModeAoeRadius, 80, v => update("bijuuModeAoeRadius", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>AoE Dmg</label>
  ...
  if (t === "tailed_beast_bomb") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Radius</label>
  ...
  if (t === "curse_mark_2") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Crit Mult</label>
  ...
  if (t === "berserk_hollow") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Min Dmg</label>
        {numInput(turret.berserkHollowMinDmg, 15, v => update("berserkHollowMinDmg", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Max Dmg</label>
  ...
  if (t === "clay_spider") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Speed px/s</label>
        {numInput(turret.claySpiderSpeed, 150, v => update("claySpiderSpeed", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Expl Radius</label>
  ...
  if (t === "clay_clones_c4") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>DoT/s</label>
  ...
  if (t === "katsu") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Dmg/Clay</label>
  ...
  if (t === "shinra_tensei") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Force</label>
  ...
  if (t === "chibaku_tensei") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Hold (s)</label>
        {numInput(turret.chibakuTenseiHoldSec, 3, v => update("chibakuTenseiHoldSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Crush Radius</label>
        {numInput(turret.chibakuTenseiCrushRadius, 60, v => update("chibakuTenseiCrushRadius", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Crush Dmg</label>
  ...
  if (t === "samehada_drain") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Drain/s</label>
  ...
  if (t === "jashin_ritual") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Reflect Frac</label>
        {numInput(turret.jashinReflectFraction, 0.8, v => update("jashinReflectFraction", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Link (s)</label>
  ...
  if (t === "kamui") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Absorb (s)</label>
  ...
  if (t === "limbo_hengoku") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Hits</label>
        {numInput(turret.limboHits, 4, v => update("limboHits", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Dmg/Hit</label>
  ...
  if (t === "wood_dragon") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Trap (s)</label>
  ...
  if (t === "spiral_eye") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Fling Force</label>
  ...
  if (t === "phantom_pass") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Burst Radius</label>
        {numInput(turret.phantomPassBurstRadius, 120, v => update("phantomPassBurstRadius", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Burst Dmg</label>
  ...
  if (t === "black_zetsu_bind") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Bind (s)</label>
        {numInput(turret.blackZetsuBindSec, 3, v => update("blackZetsuBindSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Drain DPS</label>
  ...
  if (t === "orange_mask_dash") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 85 }}>Range (cm)</label>
  ...
  if (t === "truth_seeker_orbs") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Orbs</label>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Radius</label>
        {numInput(turret.truthSeekerOrbRadius, 40, v => update("truthSeekerOrbRadius", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Duration</label>
  ...
  if (t === "asura_path") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Dmg/Missile</label>
        {numInput(turret.asuraPathMissileDamage, 40, v => update("asuraPathMissileDamage", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Knockback</label>
  ...
  if (t === "eight_gates_release") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Speed ×</label>
        {numInput(turret.eightGatesSpeedMult, 2.0, v => update("eightGatesSpeedMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Dmg ×</label>
        {numInput(turret.eightGatesDamageMult, 1.8, v => update("eightGatesDamageMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>HP Cost/s</label>
  ...
  if (t === "kaguya_bones") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Bone Count</label>
        {numInput(turret.kaguyaBoneCount, 5, v => update("kaguyaBoneCount", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Dmg/Spike</label>
  ...
  if (t === "respira") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Spin Decay×</label>
        {numInput(turret.respiraSpinDecayMult, 5, v => update("respiraSpinDecayMult", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 50 }}>DPS</label>
  ...
  if (t === "desgarron") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Dmg/Slash</label>
        {numInput(turret.desgarronDamage, 80, v => update("desgarronDamage", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Slashes</label>
  ...
  if (t === "kamehameha") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Width (cm)</label>
  ...
  if (t === "spirit_bomb") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Charge (s)</label>
  ...
  if (t === "hadoken") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Speed px/s</label>
  ...
  if (t === "spiral_drill") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Hits</label>
  ...
  if (t === "electric_body") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Radius</label>
  ...
  if (t === "senbonzakura") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Shards</label>
        {numInput(turret.senbonzakuraShards, 30, v => update("senbonzakuraShards", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Dmg/Shard</label>
  ...
  if (t === "daiguren_ice") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Expand px/s</label>
        {numInput(turret.daiGurenExpandSpeed, 120, v => update("daiGurenExpandSpeed", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Max Radius</label>
  ...
  if (t === "absolute_zero") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Shatter Dmg</label>
  ...
  if (t === "muken_poison") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Init Radius</label>
        {numInput(turret.mukenPoisonInitRadius, 60, v => update("mukenPoisonInitRadius", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Expand px/s</label>
  ...
  if (t === "zanka_incinerate") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Fire Boost</label>
  ...
  if (t === "suzumebachi") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>1st Hit Dmg</label>
        {numInput(turret.suzumebachiFirstHitDmg, 10, v => update("suzumebachiFirstHitDmg", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Kill Threshold</label>
  ...
  if (t === "hihio_construct") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Sweep Arc°</label>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Trail ms</label>
  ...
  if (t === "chidori") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Length (cm)</label>
  ...
  if (t === "shadow_clone") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Directions</label>
  ...
  if (t === "susanoo") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Shield (s)</label>
        {numInput(turret.susanooShieldSec, 5, v => update("susanooShieldSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Counter Dmg</label>
  ...
  if (t === "substitution") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Invuln (s)</label>
  ...
  if (t === "shadow_shuriken") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Diverge°</label>
        {numInput(turret.shadowShurikenAngleDeg, 15, v => update("shadowShurikenAngleDeg", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Dmg Each</label>
  ...
  if (t === "kunai_barrage") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Spread°</label>
        {numInput(turret.kunaiBarrageSpreadDeg, 60, v => update("kunaiBarrageSpreadDeg", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Dmg/Kunai</label>
  ...
  if (t === "smoke_bomb") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Spin Gain×</label>
  ...
  if (t === "exploding_tag") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Trigger Radius</label>
  ...
  if (t === "ultra_form") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Boost Mult</label>
  ...
  if (t === "sage_mode") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Power Mult</label>
        {numInput(turret.sageModePowerMult, 1.8, v => update("sageModePowerMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Regen/s</label>
  ...
  if (t === "bankai_release") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Pulse Radius</label>
  ...
  if (t === "susanoo_full") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Shield Rad</label>
  ...
  if (t === "titan_shift") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Pulse Dmg</label>
  ...
  if (t === "summon_toad") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Slam Radius</label>
  ...
  if (t === "summon_snake") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Hold (s)</label>
  ...
  if (t === "summon_slug") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Heal/s</label>
  ...
  if (t === "summon_eagle") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Dive Radius</label>
  ...
  if (t === "summon_clones") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Clones</label>
        {numInput(turret.summonClonesCount, 8, v => update("summonClonesCount", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Dmg/Clone</label>
  ...
  if (t === "wind_god_fist") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Launch Force</label>
  ...
  if (t === "laser_scraper") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Dmg/Degree</label>
  ...
  if (t === "heat_smash") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Ignite (s)</label>
  ...
  if (t === "ki_charge_tek") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Boost Mult</label>
  ...
  if (t === "twin_pistols") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Dmg/Shot</label>
        {numInput(turret.twinPistolsDmgPerShot, 18, v => update("twinPistolsDmgPerShot", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Converge px</label>
  ...
  if (t === "time_warp") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Rewind (s)</label>
      {numInput(turret.timeWarpRewindSec, 2, v => update("timeWarpRewindSec", v), 0.5)}
    </div>
  );
  if (t === "time_stop") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Freeze (s)</label>
      {numInput(turret.timeStopDurationSec, 1.5, v => update("timeStopDurationSec", v), 0.25)}
    </div>
  );
  if (t === "time_loop") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Loop Delay (s)</label>
  ...
  if (t === "time_acceleration") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Decay Mult</label>
  ...
  if (t === "age_drain") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 85 }}>Drain Frac/s</label>
  ...
  if (t === "minazuki_heal") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Heal/s</label>
  ...
  if (t === "senbonzakura_kageyoshi") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Waves</label>
        {numInput(turret.senbonzakuraKageyoshiWaves, 3, v => update("senbonzakuraKageyoshiWaves", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Dmg/Wave</label>
  ...
  if (t === "hierro") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Dmg Reduction</label>
  ...
  if (t === "descorrer") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Pull Radius</label>
  ...
  if (t === "lanza_del_relampago") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Explosion Rad</label>
  ...
  if (t === "santa_teresa") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Wave Width</label>
  ...
  if (t === "kido_hado_63") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Paralysis (s)</label>
  ...
  if (t === "kido_hado_90") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Trap (s)</label>
  ...
  if (t === "kido_bakudo_61") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Lock (s)</label>
  ...
  if (t === "tsukuyomi") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Inversion (s)</label>
  ...
  if (t === "amaterasu_mark") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Mark (s)</label>
        {numInput(turret.amaterasuMarkDurationSec, 10, v => update("amaterasuMarkDurationSec", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Trigger Dmg</label>
  ...
  if (t === "izanami") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Loop (s)</label>
      {numInput(turret.izanamiLoopSec, 2, v => update("izanamiLoopSec", v), 0.5)}
    </div>
  );
  if (t === "sharingan_lock") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Mirror (s)</label>
      {numInput(turret.sharinganLockSec, 2.5, v => update("sharinganLockSec", v), 0.5)}
    </div>
  );
  if (t === "crow_genjutsu") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Chaos (s)</label>
  ...
  if (t === "susanoo_itachi") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Seal (s)</label>
  ...
  if (t === "summon_ryuchi") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Venom/s</label>
  ...
  if (t === "summon_myoboku") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Oil Damage</label>
        {numInput(turret.summonMyobokuOilDmg, 50, v => update("summonMyobokuOilDmg", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Boost (s)</label>
  ...
  if (t === "summon_garuda") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Wind Radius</label>
  ...
  if (t === "summon_enma") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Reach (cm)</label>
  ...
  if (t === "summon_gamaken") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Spin Arc°</label>
  ...
  if (t === "edo_tensei") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>HP Fraction</label>
  ...
  if (t === "cosmic_power") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Atk Reduction</label>
        {numInput(turret.cosmicPowerAtkReduction, 0.75, v => update("cosmicPowerAtkReduction", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Range Boost</label>
  ...
  if (t === "mirror_world") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Offset (cm)</label>
  ...
  if (t === "perfect_mirage") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Invisible (s)</label>
      {numInput(turret.perfectMirageDurationSec, 2.5, v => update("perfectMirageDurationSec", v), 0.5)}
    </div>
  );
  if (t === "broken_reality") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 85 }}>Scatter Radius</label>
  ...
  if (t === "echo_image") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Decoy HP</label>
  ...
  if (t === "genjutsu_veil") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Drift/tick (cm)</label>
  ...
  if (t === "false_flag") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Swap Duration</label>
      {numInput(turret.falseFlagDurationSec, 5, v => update("falseFlagDurationSec", v), 0.5)}
    </div>
  );
  if (t === "mind_fracture") return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <label className="text-[11px] text-faint" style={{ minWidth: 80 }}>Duration (s)</label>
  ...
  if (t === "spread_bey") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Vectors</label>
        {numInput(turret.spreadBeyCount, 5, v => update("spreadBeyCount", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Arc Half°</label>
        {numInput(turret.spreadBeyArcHalfDeg, 30, v => update("spreadBeyArcHalfDeg", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Dmg/vector</label>
  ...
  if (t === "railbey") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Speed×</label>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Pierce Dmg</label>
  ...
  if (t === "minigun_bey") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Pulses</label>
        {numInput(turret.minigunBeyPulses, 12, v => update("minigunBeyPulses", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Interval (ms)</label>
        {numInput(turret.minigunBeyIntervalMs, 60, v => update("minigunBeyIntervalMs", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Dmg/pulse</label>
  ...
  if (t === "heat_seeker_bey") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Ram Speed</label>
        {numInput(turret.heatSeekerBeySpeed, 600, v => update("heatSeekerBeySpeed", v), 50)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Impact Dmg</label>
  ...
  if (t === "bomb_bey") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Fuse (s)</label>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Damage</label>
  ...
  if (t === "shield_bey") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Retaliation Dmg</label>
        {numInput(turret.shieldBeyRetaliationDmg, 80, v => update("shieldBeyRetaliationDmg", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Burst Radius</label>
  ...
  if (t === "turbo_bey") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Spin Boost</label>
  ...
  if (t === "cannon_bey") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Launch Force</label>
  ...
  if (t === "gravity_flip") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 70 }}>Repel Force</label>
  ...
  if (t === "magnet_bey") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Chase Force</label>
  ...
  if (t === "bounce_storm") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 75 }}>Recoil Mult</label>
  ...
  if (t === "boomerang_path") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 60 }}>Speed °/s</label>
  ...
  if (t === "teleport_dash") return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 55 }}>Blinks</label>
        {numInput(turret.teleportDashCount, 3, v => update("teleportDashCount", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Interval (s)</label>
        {numInput(turret.teleportDashIntervalSec, 0.4, v => update("teleportDashIntervalSec", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint" style={{ minWidth: 65 }}>Blink Radius</label>
  ...
  return (
    ...
    <div className="flex flex-col gap-4">
      <div className="flex justify-between items-center">
        <span className="text-[13px] text-muted">{items.length} / 8 turrets</span>
        <button onClick={add} disabled={items.length >= 8} className="py-[5px] px-[14px] text-white border-none rounded-md text-xs font-medium cursor-pointer bg-red" style={{ opacity: items.length >= 8 ? 0.4 : 1 }}>
          + Add Turret
        </button>
      </div>
      ...
      {items.map((turret, idx) => (
        <div key={turret.id ?? idx} className="bg-bg3 rounded-xl p-4 border border-border">
          {/* Header */}
          <div className="flex justify-between items-center mb-3">
            <div className="flex items-center gap-2">
              <span className="text-[13px] font-medium text-text">🔫 Turret #{idx + 1}</span>
              {turret.behaviorId && (
            ...
            <div className="flex gap-2 items-center">
              ...
              <button onClick={() => remove(turret.id)} className="text-red bg-transparent border-none text-xs cursor-pointer">Remove</button>
            </div>
          </div>

          {/* Attack type */}
          <div className="mb-3">
            <label className="block text-[11px] text-faint mb-1.5">Attack Type</label>
            <SearchableSelect
          ...
          <div className="bg-bg2 rounded-lg p-2.5 mb-3">
            <div className="text-[11px] text-faint mb-1.5">Attack Type Config</div>
            <TypeSpecificParams turret={turret} update={(field, val) => update(turret.id, field, val)} />
          </div>

          {/* Fire pattern */}
          <div className="mb-3">
            <label className="block text-[11px] text-faint mb-1">Fire Pattern</label>
            <div className="flex gap-1 flex-wrap">
              {FIRE_PATTERNS.map(p => (
                <button key={p.value} onClick={() => update(turret.id, "firePattern", p.value)}
                  className="py-[2px] px-2 rounded text-[10px] cursor-pointer border"
                  style={{
                    background: (turret.firePattern ?? "nearest") === p.value ? C.red : "transparent",
                    color: (turret.firePattern ?? "nearest") === p.value ? C.white : C.muted,
                    borderColor: (turret.firePattern ?? "nearest") === p.value ? C.red : C.border,
                  }}>
                  {p.label}
                </button>
              ))}
          ...
          {/* Sprite pickers */}
          <div className="grid gap-2.5 mb-3" style={{ gridTemplateColumns: "1fr 1fr" }}>
            <div>
              <label className="block text-[11px] text-faint mb-1">Turret Sprite</label>
              <SearchableSelect
            ...
            <div>
              <label className="block text-[11px] text-faint mb-1">Projectile Sprite</label>
              <SearchableSelect
          ...
          <div className="mt-3 grid gap-2.5" style={{ gridTemplateColumns: "1fr 1fr" }}>
            ...
            <div>
              ...
              <textarea
                ...
                rows={2}
                className="w-full bg-bg2 border border-border text-text rounded-md py-1 px-2 text-[11px] font-mono box-border"
          ...
          {/* Feature Animation */}
          <div className="mt-3 bg-bg2 rounded-lg p-2.5">
          ...
          <div className="grid gap-2.5 mb-2" style={{ gridTemplateColumns: "1fr 1fr" }}>
            <div>
