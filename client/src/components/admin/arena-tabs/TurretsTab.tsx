...
function numInput(val: number | undefined, def: number, onChange: (n: number) => void, step = 1, wClass = "w-20") {
  return (
    <input
      type="number" value={val ?? def} step={step}
      onChange={e => onChange(Number(e.target.value))}
      className={`bg-bg1 border border-border-c text-theme-text rounded-md py-1 px-2 text-xs ${wClass}`}
    />
  );
}

function cmNumInput(val: number | undefined, defPx: number, onChange: (n: number) => void, _step = 1, wClass = "w-20") {
...
function TypeSpecificParams({ turret, update }: { turret: TurretConfig; update: (field: keyof TurretConfig, value: any) => void }) {
    ...
    <div className="grid grid-cols-2 gap-2">
      <div>
        ...
        <input type="range" min={50} max={800} step={25} value={turret.bulletSpeed ?? 200}
          onChange={e => update("bulletSpeed", +e.target.value)} className="w-full" />
      </div>
      <div>
        <div className="flex justify-between text-[11px] text-faint mb-0.5">
        ...
        <input type="range" min={1} max={10} step={1} value={turret.bulletCount ?? 1}
          onChange={e => update("bulletCount", +e.target.value)} className="w-full" />
      </div>
    </div>
  );
  if (t === "beam") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Beam Duration (s)</label>
        {numInput(turret.beamDuration, 3, v => update("beamDuration", v), 0.5)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Charge Period (s)</label>
  ...
  if (t === "aoe") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[80px]">AoE Radius (cm)</label>
        {cmNumInput(turret.aoeRadius, 80, v => update("aoeRadius", v), 10)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[80px]">Damage Radius (cm)</label>
  ...
  if (t === "boomerang") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Return Time (s)</label>
  ...
  if (t === "laser_sweep") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[75px]">Sweep Arc (°)</label>
        {numInput(turret.laserSweepArcDeg, 180, v => update("laserSweepArcDeg", v), 10)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[80px]">Sweep Speed (°/s)</label>
  ...
  if (t === "sniper") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Charge Time (s)</label>
      {numInput(turret.sniperChargeSec, 2, v => update("sniperChargeSec", v), 0.5)}
    </div>
  );
  if (t === "shotgun") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Cone Half-Angle (°)</label>
  ...
  if (t === "mine_layer") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[85px]">Trigger Radius (cm)</label>
        {cmNumInput(turret.mineTriggerRadius, 50, v => update("mineTriggerRadius", v), 5)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[85px]">Lifetime (s, 0=∞)</label>
  ...
  if (t === "gravity_cannon") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[70px]">Force (N)</label>
        {numInput(turret.gravityCannonForce, 0.01, v => update("gravityCannonForce", v), 0.001)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[70px]">Duration (s)</label>
  ...
  if (t === "emp") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Disable Ticks</label>
      {numInput(turret.empDisableTicks, 120, v => update("empDisableTicks", Math.round(v)), 10)}
    </div>
  );
  if (t === "tracking_missile") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Tracking (°/s)</label>
  ...
  if (t === "burst_fire") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Burst Count</label>
        {numInput(turret.burstCount, 4, v => update("burstCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Interval (s)</label>
        {numInput(turret.burstIntervalSec, 0.15, v => update("burstIntervalSec", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Reload (s)</label>
  ...
  if (t === "plasma_ring") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[80px]">Expand Speed (px/s)</label>
        {numInput(turret.plasmaRingExpandSpeed, 150, v => update("plasmaRingExpandSpeed", v), 10)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[80px]">Max Radius (cm)</label>
  ...
  if (t === "tractor_beam") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Pull Force (N)</label>
  ...
  if (t === "surf") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Wave Width (cm)</label>
        {cmNumInput(turret.surfWaveWidthPx, 120, v => update("surfWaveWidthPx", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Wave Speed (px/s)</label>
        {numInput(turret.surfWaveSpeedPx, 400, v => update("surfWaveSpeedPx", v), 20)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Slow Mult</label>
  ...
  if (t === "hydro_pump") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Knockback</label>
        {numInput(turret.hydroPumpKnockback, 0.08, v => update("hydroPumpKnockback", v), 0.005)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Slow Duration (s)</label>
  ...
  if (t === "fire_spin") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Ring Radius (cm)</label>
        {cmNumInput(turret.fireSpinRadiusPx, 60, v => update("fireSpinRadiusPx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Duration (s)</label>
        {numInput(turret.fireSpinDurationSec, 3, v => update("fireSpinDurationSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Spin Drain/s</label>
  ...
  if (t === "thunderbolt") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Stun Duration (s)</label>
  ...
  if (t === "psychic") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Cycle (s)</label>
        {numInput(turret.psychicCycleIntervalSec, 2, v => update("psychicCycleIntervalSec", v), 0.25)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Force (N)</label>
  ...
  if (t === "gust") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Wind Angle (°)</label>
  ...
  if (t === "shadow_ball") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[85px]">Speed (px/s)</label>
        {numInput(turret.shadowBallSpeedPx, 180, v => update("shadowBallSpeedPx", v), 10)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[85px]">Fragments</label>
  ...
  if (t === "fire_blast") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[50px]">Petals</label>
        {numInput(turret.fireBlastPetals, 5, v => update("fireBlastPetals", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Burn/s</label>
        {numInput(turret.fireBlastBurnPerSec, 8, v => update("fireBlastBurnPerSec", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Burn Dur (s)</label>
  ...
  if (t === "sludge_bomb") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Zone Radius (cm)</label>
        {cmNumInput(turret.sludgeBombRadiusPx, 70, v => update("sludgeBombRadiusPx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Lifetime (s)</label>
  ...
  if (t === "toxic_spikes") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Spike Count</label>
        {numInput(turret.toxicSpikeCount, 4, v => update("toxicSpikeCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Trigger (cm)</label>
        {cmNumInput(turret.toxicSpikeTriggerPx, 30, v => update("toxicSpikeTriggerPx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Poison/s</label>
  ...
  if (t === "roar") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Scramble Duration (s)</label>
  ...
  if (t === "multi_missile") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Missile Count</label>
        {numInput(turret.multiMissileCount, 3, v => update("multiMissileCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Spread Delay (s)</label>
  ...
  if (t === "blizzard") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Cone Half (°)</label>
        {numInput(turret.blizzardConeHalfDeg, 50, v => update("blizzardConeHalfDeg", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Freeze (s)</label>
        {numInput(turret.blizzardFreezeDurationSec, 2, v => update("blizzardFreezeDurationSec", v), 0.25)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Ice Patch (s)</label>
        {numInput(turret.blizzardIcePatchDurationSec, 4, v => update("blizzardIcePatchDurationSec", v), 0.5)}
      </div>
      <label className="flex gap-1.5 items-center text-[11px] text-faint col-span-3">
  ...
  if (t === "earthquake") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[75px]">Wave Count</label>
        {numInput(turret.earthquakeWaves, 3, v => update("earthquakeWaves", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Wave Interval (s)</label>
  ...
  if (t === "flamethrower") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Beam Width (cm)</label>
        {cmNumInput(turret.flamethrowerBeamWidthPx, 15, v => update("flamethrowerBeamWidthPx", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Burn/s</label>
        {numInput(turret.flamethrowerBurnPerSec, 8, v => update("flamethrowerBurnPerSec", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Burn Dur (s)</label>
  ...
  if (t === "ice_beam") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Freeze (s)</label>
        {numInput(turret.iceBeamFreezeDurationSec, 2, v => update("iceBeamFreezeDurationSec", v), 0.25)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Spin Drain/s</label>
  ...
  if (t === "dragon_breath") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Stagger %</label>
        {numInput((turret.dragonBreathStaggerChance ?? 0.35) * 100, 35, v => update("dragonBreathStaggerChance", v / 100), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Stagger (s)</label>
  ...
  if (t === "confuse_ray") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Confusion (s)</label>
  ...
  if (t === "leech_seed") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">HP Drain/s</label>
        {numInput(turret.leechSeedHealthPerSec, 5, v => update("leechSeedHealthPerSec", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Spin Drain/s</label>
  ...
  if (t === "vine_whip") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Grip (s)</label>
        {numInput(turret.vineWhipGripDurationSec, 2, v => update("vineWhipGripDurationSec", v), 0.25)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Pull Force (N)</label>
  ...
  if (t === "hyper_beam") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Charge (s)</label>
        {numInput(turret.hyperBeamChargeSec, 4, v => update("hyperBeamChargeSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Recharge (s)</label>
  ...
  if (t === "gravity_field") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Duration (s)</label>
  ...
  if (t === "sand_tomb") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Pushback (N)</label>
  ...
  if (t === "zap_cannon") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Speed (px/s)</label>
        {numInput(turret.zapCannonSpeedPx, 100, v => update("zapCannonSpeedPx", v), 10)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[90px]">Paralysis (s)</label>
  ...
  if (t === "overheat") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Dmg Mult</label>
        {numInput(turret.overheatDamageMult, 3.0, v => update("overheatDamageMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">CD Mult</label>
        {numInput(turret.overheatCooldownMult, 3.0, v => update("overheatCooldownMult", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Penalty Shots</label>
  ...
  if (t === "chain_lightning") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Jumps</label>
        {numInput(turret.chainLightningJumps, 3, v => update("chainLightningJumps", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Dmg Decay</label>
        {numInput((turret.chainLightningDecay ?? 0.5) * 100, 50, v => update("chainLightningDecay", v / 100), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Stun (s)</label>
  ...
  if (t === "spore") return (
    <div className="grid grid-cols-4 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Radius (cm)</label>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Drain Mult</label>
        {numInput(turret.sporeSpinDrainMult, 2.0, v => update("sporeSpinDrainMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Sleep (s)</label>
  ...
  if (t === "dark_void") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[75px]">Void Count</label>
        {numInput(turret.darkVoidCount, 3, v => update("darkVoidCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-2">
        <label className="text-[11px] text-faint min-w-[75px]">Speed (px/s)</label>
  ...
  if (t === "rock_slide") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Boulders</label>
        {numInput(turret.rockSlideBoulderCount, 5, v => update("rockSlideBoulderCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Scatter (cm)</label>
        {cmNumInput(turret.rockSlideScatterPx, 120, v => update("rockSlideScatterPx", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">AoE (cm)</label>
  ...
  if (t === "whirlpool") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Orbit Force</label>
  ...
  if (t === "stealth_rock") return (
    <div className="grid grid-cols-4 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Count</label>
        {numInput(turret.stealthRockCount, 6, v => update("stealthRockCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Radius (cm)</label>
        {cmNumInput(turret.stealthRockRadiusPx, 40, v => update("stealthRockRadiusPx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Dmg/s</label>
        {numInput(turret.stealthRockDmgPerSec, 4, v => update("stealthRockDmgPerSec", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Lifetime (s)</label>
  ...
  if (t === "ember") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Burn Ticks</label>
        {numInput(turret.emberBurnTicks, 3, v => update("emberBurnTicks", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Tick Dmg</label>
        {numInput(turret.emberBurnTickDmg, 5, v => update("emberBurnTickDmg", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Interval (s)</label>
  ...
  if (t === "magma_storm") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Ring Width (cm)</label>
        {cmNumInput(turret.magmaStormRingWidthPx, 24, v => update("magmaStormRingWidthPx", v), 2)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Rotation (°/s)</label>
  ...
  if (t === "eruption") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Geyser AoE (cm)</label>
        {cmNumInput(turret.eruptionGeyserAoePx, 80, v => update("eruptionGeyserAoePx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Extra Dmg/Bey</label>
  ...
  if (t === "bubble_beam") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Bubbles</label>
        {numInput(turret.bubbleBeamCount, 3, v => update("bubbleBeamCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Slow Mult</label>
        {numInput(turret.bubbleBeamSlowMult, 0.65, v => update("bubbleBeamSlowMult", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Slow Dur (s)</label>
  ...
  if (t === "aqua_ring") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Duration (s)</label>
  ...
  if (t === "origin_pulse") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Wave Count</label>
        {numInput(turret.originPulseWaveCount, 2, v => update("originPulseWaveCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Push Force</label>
  ...
  if (t === "icicle_spear") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Spears</label>
        {numInput(turret.icicleSpearCount, 5, v => update("icicleSpearCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Interval (ms)</label>
  ...
  if (t === "hail") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[50px]">Chunks</label>
        {numInput(turret.hailChunkCount, 6, v => update("hailChunkCount", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Scatter (cm)</label>
        {cmNumInput(turret.hailScatterRadiusPx, 100, v => update("hailScatterRadiusPx", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">AoE (cm)</label>
  ...
  if (t === "glacial_lance") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Width (cm)</label>
        {cmNumInput(turret.glacialLanceWidthPx, 60, v => update("glacialLanceWidthPx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Freeze (s)</label>
  ...
  if (t === "thunder_wave") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Speed Mult</label>
  ...
  if (t === "bolt_strike") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Bolts</label>
        {numInput(turret.boltStrikeBolts, 1, v => update("boltStrikeBolts", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Paralysis (s)</label>
  ...
  if (t === "air_slash") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Flinch Chance</label>
        {numInput(turret.airSlashFlinchChance, 0.3, v => update("airSlashFlinchChance", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Flinch (s)</label>
  ...
  if (t === "hurricane") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Speed (px/s)</label>
        {numInput(turret.hurricaneSpeedPx, 200, v => update("hurricaneSpeedPx", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Zone (s)</label>
  ...
  if (t === "aeroblast") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Beam Width (cm)</label>
        {cmNumInput(turret.aeroblastBeamWidthPx, 50, v => update("aeroblastBeamWidthPx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Push Force</label>
  ...
  if (t === "stone_edge") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[50px]">Shards</label>
        {numInput(turret.stoneEdgeShards, 3, v => update("stoneEdgeShards", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Crit Chance</label>
        {numInput(turret.stoneEdgeCritChance, 0.5, v => update("stoneEdgeCritChance", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Crit Mult</label>
  ...
  if (t === "dig") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Delay (ms)</label>
        {numInput(turret.digDelayMs, 800, v => update("digDelayMs", v), 50)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Surface AoE (cm)</label>
  ...
  if (t === "tectonic_rage") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Fissures</label>
        {numInput(turret.tectonicRageFissures, 4, v => update("tectonicRageFissures", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Width (cm)</label>
  ...
  if (t === "flash_cannon") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[100px]">Beam Dur (s)</label>
  ...
  if (t === "bullet_punch") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[50px]">Hits</label>
  ...
  if (t === "steel_surge") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Dmg/Tick</label>
  ...
  if (t === "absorb") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">HP Drain/s</label>
  ...
  if (t === "petal_dance") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Petals</label>
  ...
  if (t === "bloom_doom") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Absorb (s)</label>
        {numInput(turret.bloomDoomAbsorbSec, 2, v => update("bloomDoomAbsorbSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Burst Force Mult</label>
  ...
  if (t === "night_shade") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[90px]">HP Fraction</label>
  ...
  if (t === "phantom_force") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Dmg/s</label>
  ...
  if (t === "flash") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[90px]">Blind (s)</label>
  ...
  if (t === "solar_beam") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Charge (s)</label>
  ...
  if (t === "solar_flare") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Blind (s)</label>
        {numInput(turret.solarFlareBlindSec, 3, v => update("solarFlareBlindSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Flat Dmg</label>
  ...
  if (t === "spark") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Wet Dmg Mult</label>
  ...
  if (t === "magnetic_field") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Orbit Force</label>
  ...
  if (t === "thunder_storm") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Strike Int (s)</label>
        {numInput(turret.thunderStormStrikeIntervalSec, 1.5, v => update("thunderStormStrikeIntervalSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Strike Dmg</label>
  ...
  if (t === "distortion") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Teleport Radius (cm)</label>
  ...
  if (t === "black_hole_shot") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Pull Force</label>
  ...
  if (t === "spacial_rend") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Damage</label>
        {numInput(turret.spacialRendDamage, 50, v => update("spacialRendDamage", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[90px]">Scatter Radius (cm)</label>
  ...
  if (t === "cross_slash") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Range (cm)</label>
        {cmNumInput(turret.crossSlashRangePx, 80, v => update("crossSlashRangePx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Bonus Mult</label>
  ...
  if (t === "impact_burst") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Knockback</label>
        {numInput(turret.impactBurstKnockback, 0.07, v => update("impactBurstKnockback", v), 0.005)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Confusion (s)</label>
  ...
  if (t === "armor_pierce") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Shatter Dur (s)</label>
  ...
  if (t === "flurry_barrage") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[50px]">Shots</label>
        {numInput(turret.flurryBarrageHits, 5, v => update("flurryBarrageHits", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Escalate Mult</label>
        {numInput(turret.flurryBarrageEscalateMult, 0.3, v => update("flurryBarrageEscalateMult", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Interval (ms)</label>
  ...
  if (t === "mach_shot") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[100px]">Speed Mult</label>
  ...
  if (t === "gravity_grip") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Hold (s)</label>
        {numInput(turret.gravityGripHoldSec, 2, v => update("gravityGripHoldSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Spin Drain/s</label>
  ...
  if (t === "ram_charge") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Stun Chance</label>
        {numInput(turret.ramChargeStunChance, 0.3, v => update("ramChargeStunChance", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Stun (s)</label>
  ...
  if (t === "graviton_throw") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[90px]">Push Force</label>
  ...
  if (t === "razor_spin") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Dmg/s</label>
  ...
  if (t === "point_blank") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Max Range (cm)</label>
        {cmNumInput(turret.pointBlankRangePx, 60, v => update("pointBlankRangePx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Dmg Mult</label>
  ...
  if (t === "static_field") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Shock Dmg</label>
        {numInput(turret.staticFieldShockDmg, 15, v => update("staticFieldShockDmg", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Cooldown (ms)</label>
  ...
  if (t === "acid_spray") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Def Break Mult</label>
        {numInput(turret.acidSprayDefBreakMult, 1.5, v => update("acidSprayDefBreakMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Debuff (s)</label>
  ...
  if (t === "spin_slash") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[50px]">Arms</label>
        {numInput(turret.spinSlashArms, 3, v => update("spinSlashArms", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Speed (°/s)</label>
  ...
  if (t === "guillotine") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Spin Threshold</label>
  ...
  if (t === "anti_grav") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Airborne (s)</label>
        {numInput(turret.antiGravAirborneSec, 1.5, v => update("antiGravAirborneSec", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Slam AoE (cm)</label>
        {cmNumInput(turret.antiGravSlamAoePx, 70, v => update("antiGravSlamAoePx", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Slam Dmg</label>
  ...
  if (t === "drain_sting") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Steal Fraction</label>
  ...
  if (t === "sting_bolt") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Crit Chance</label>
        {numInput(turret.stingBoltCritChance, 0.3, v => update("stingBoltCritChance", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Crit Mult</label>
  ...
  if (t === "dark_pulse") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Stagger (s)</label>
        {numInput(turret.darkPulseStaggerSec, 1.0, v => update("darkPulseStaggerSec", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Spin Drain %</label>
  ...
  if (t === "steel_ram") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Stun (s)</label>
  ...
  if (t === "metal_sound") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Def Break Mult</label>
  ...
  if (t === "magnet_bomb") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Pull (s)</label>
        {numInput(turret.magnetBombPullSec, 1.0, v => update("magnetBombPullSec", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Explosion (cm)</label>
  ...
  if (t === "drill_shot") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Pierce (cm)</label>
  ...
  if (t === "hyper_voice") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Stagger (s)</label>
  ...
  if (t === "swords_dance") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Charges</label>
        {numInput(turret.swordsDanceCharges, 3, v => update("swordsDanceCharges", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Dmg Mult</label>
  ...
  if (t === "tail_whip") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Dmg Taken Mult</label>
  ...
  if (t === "growl") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Spin Drain Mult</label>
  ...
  if (t === "meditate") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[90px]">Dmg Mult</label>
      {numInput(turret.meditateMult, 4.0, v => update("meditateMult", v), 0.5)}
    </div>
  );
  if (t === "nasty_plot") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Bypass Shots</label>
  ...
  if (t === "agility") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Cooldown Mult</label>
  ...
  if (t === "poison_jab") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Stacks</label>
        {numInput(turret.poisonJabStacks, 1, v => update("poisonJabStacks", Math.round(v)), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">DoT/s/Stack</label>
        {numInput(turret.poisonJabDotPerSec, 5, v => update("poisonJabDotPerSec", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">DoT Dur (s)</label>
  ...
  if (t === "future_sight") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Delay (s)</label>
  ...
  if (t === "dragon_slash") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Stagger Chance</label>
  ...
  if (t === "outrage") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Rampage (s)</label>
        {numInput(turret.outrageRampageSec, 3.0, v => update("outrageRampageSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Recoil (s)</label>
        {numInput(turret.outrageRecoilSec, 2.0, v => update("outrageRecoilSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Hit Int (ms)</label>
  ...
  if (t === "hex") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Status Mult</label>
      {numInput(turret.hexStatusMult, 2.0, v => update("hexStatusMult", v), 0.1)}
    </div>
  );
  if (t === "ghost_strike") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[100px]">Max Range (cm)</label>
  ...
  if (t === "dazzling_gleam") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Lock (s)</label>
  ...
  if (t === "charge") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[85px]">Paralysis Chance</label>
  ...
  if (t === "skull_bash") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Charge (s)</label>
        {numInput(turret.chargeCannonChargeSec, 1.5, v => update("chargeCannonChargeSec", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Knockdown (s)</label>
  ...
  if (t === "flare_blitz") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Recoil Frac</label>
        {numInput(turret.flareBlitzRecoilFraction, 0.33, v => update("flareBlitzRecoilFraction", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Burn (s)</label>
  ...
  if (t === "uppercut") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Airborne (s)</label>
  ...
  if (t === "launch_spike") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[90px]">Spike AoE (cm)</label>
  ...
  if (t === "spear_chain") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Pull Force</label>
  ...
  if (t === "cryo_lance") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Shatter Mult</label>
  ...
  if (t === "ring_blade") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Passes</label>
  ...
  if (t === "portal_strike") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Burst Radius (cm)</label>
  ...
  if (t === "dragon_fireball") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Bounces</label>
  ...
  if (t === "inferno_slam") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[90px]">AoE (cm)</label>
  ...
  if (t === "harden") return (
    <div className="flex items-center gap-2">
      <label className="text-[11px] text-faint min-w-[110px]">Invuln Duration (s)</label>
  ...
  if (t === "defense_curl") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Invuln (s)</label>
        {numInput(turret.defenseCurlDurationSec, 1.0, v => update("defenseCurlDurationSec", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Next Shot Mult</label>
  ...
  if (t === "enlarge") return (
    <div className="grid grid-cols-4 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Radius Scale</label>
        {numInput(turret.enlargeRadiusScale, 1.5, v => update("enlargeRadiusScale", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Collision Mult</label>
        {numInput(turret.enlargeCollisionMult, 1.8, v => update("enlargeCollisionMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Speed Mult</label>
  ...
  if (t === "mass_shift") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">KB Resist</label>
        {numInput(turret.massShiftKbResist, 0.6, v => update("massShiftKbResist", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Collision Mult</label>
  ...
  if (t === "density_crush") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">AoE Radius</label>
  ...
  if (t === "hollow_transform") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Cero Dmg</label>
        {numInput(turret.hollowTransformCeroDmg, 40, v => update("hollowTransformCeroDmg", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Pulse (ms)</label>
  ...
  if (t === "kyuubi_mode") return (
    <div className="grid grid-cols-4 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Aura Radius</label>
        {numInput(turret.kyuubiModeAuraRadius, 100, v => update("kyuubiModeAuraRadius", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">DPS</label>
  ...
  if (t === "bijuu_mode") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">AoE Radius</label>
        {numInput(turret.bijuuModeAoeRadius, 80, v => update("bijuuModeAoeRadius", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">AoE Dmg</label>
  ...
  if (t === "tailed_beast_bomb") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Radius</label>
  ...
  if (t === "curse_mark_2") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Crit Mult</label>
  ...
  if (t === "berserk_hollow") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Min Dmg</label>
        {numInput(turret.berserkHollowMinDmg, 15, v => update("berserkHollowMinDmg", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Max Dmg</label>
  ...
  if (t === "clay_spider") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Speed px/s</label>
        {numInput(turret.claySpiderSpeed, 150, v => update("claySpiderSpeed", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Expl Radius</label>
  ...
  if (t === "clay_clones_c4") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">DoT/s</label>
  ...
  if (t === "katsu") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[80px]">Dmg/Clay</label>
  ...
  if (t === "shinra_tensei") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Force</label>
  ...
  if (t === "chibaku_tensei") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Hold (s)</label>
        {numInput(turret.chibakuTenseiHoldSec, 3, v => update("chibakuTenseiHoldSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Crush Radius</label>
        {numInput(turret.chibakuTenseiCrushRadius, 60, v => update("chibakuTenseiCrushRadius", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Crush Dmg</label>
  ...
  if (t === "samehada_drain") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Drain/s</label>
  ...
  if (t === "jashin_ritual") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Reflect Frac</label>
        {numInput(turret.jashinReflectFraction, 0.8, v => update("jashinReflectFraction", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Link (s)</label>
  ...
  if (t === "kamui") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[80px]">Absorb (s)</label>
  ...
  if (t === "limbo_hengoku") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Hits</label>
        {numInput(turret.limboHits, 4, v => update("limboHits", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Dmg/Hit</label>
  ...
  if (t === "wood_dragon") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Trap (s)</label>
  ...
  if (t === "spiral_eye") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Fling Force</label>
  ...
  if (t === "phantom_pass") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Burst Radius</label>
        {numInput(turret.phantomPassBurstRadius, 120, v => update("phantomPassBurstRadius", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Burst Dmg</label>
  ...
  if (t === "black_zetsu_bind") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Bind (s)</label>
        {numInput(turret.blackZetsuBindSec, 3, v => update("blackZetsuBindSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Drain DPS</label>
  ...
  if (t === "orange_mask_dash") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[85px]">Range (cm)</label>
  ...
  if (t === "truth_seeker_orbs") return (
    <div className="grid grid-cols-4 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Orbs</label>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Radius</label>
        {numInput(turret.truthSeekerOrbRadius, 40, v => update("truthSeekerOrbRadius", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Duration</label>
  ...
  if (t === "asura_path") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Dmg/Missile</label>
        {numInput(turret.asuraPathMissileDamage, 40, v => update("asuraPathMissileDamage", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Knockback</label>
  ...
  if (t === "eight_gates_release") return (
    <div className="grid grid-cols-4 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Speed ×</label>
        {numInput(turret.eightGatesSpeedMult, 2.0, v => update("eightGatesSpeedMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Dmg ×</label>
        {numInput(turret.eightGatesDamageMult, 1.8, v => update("eightGatesDamageMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">HP Cost/s</label>
  ...
  if (t === "kaguya_bones") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Bone Count</label>
        {numInput(turret.kaguyaBoneCount, 5, v => update("kaguyaBoneCount", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Dmg/Spike</label>
  ...
  if (t === "respira") return (
    <div className="grid grid-cols-4 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Spin Decay×</label>
        {numInput(turret.respiraSpinDecayMult, 5, v => update("respiraSpinDecayMult", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[50px]">DPS</label>
  ...
  if (t === "desgarron") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Dmg/Slash</label>
        {numInput(turret.desgarronDamage, 80, v => update("desgarronDamage", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Slashes</label>
  ...
  if (t === "kamehameha") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Width (cm)</label>
  ...
  if (t === "spirit_bomb") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Charge (s)</label>
  ...
  if (t === "hadoken") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Speed px/s</label>
  ...
  if (t === "spiral_drill") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Hits</label>
  ...
  if (t === "electric_body") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Radius</label>
  ...
  if (t === "senbonzakura") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Shards</label>
        {numInput(turret.senbonzakuraShards, 30, v => update("senbonzakuraShards", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Dmg/Shard</label>
  ...
  if (t === "daiguren_ice") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Expand px/s</label>
        {numInput(turret.daiGurenExpandSpeed, 120, v => update("daiGurenExpandSpeed", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Max Radius</label>
  ...
  if (t === "absolute_zero") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Shatter Dmg</label>
  ...
  if (t === "muken_poison") return (
    <div className="grid grid-cols-4 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Init Radius</label>
        {numInput(turret.mukenPoisonInitRadius, 60, v => update("mukenPoisonInitRadius", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Expand px/s</label>
  ...
  if (t === "zanka_incinerate") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Fire Boost</label>
  ...
  if (t === "suzumebachi") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">1st Hit Dmg</label>
        {numInput(turret.suzumebachiFirstHitDmg, 10, v => update("suzumebachiFirstHitDmg", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Kill Threshold</label>
  ...
  if (t === "hihio_construct") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Sweep Arc°</label>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Trail ms</label>
  ...
  if (t === "chidori") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Length (cm)</label>
  ...
  if (t === "shadow_clone") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Directions</label>
  ...
  if (t === "susanoo") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Shield (s)</label>
        {numInput(turret.susanooShieldSec, 5, v => update("susanooShieldSec", v), 0.5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Counter Dmg</label>
  ...
  if (t === "substitution") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[80px]">Invuln (s)</label>
  ...
  if (t === "shadow_shuriken") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Diverge°</label>
        {numInput(turret.shadowShurikenAngleDeg, 15, v => update("shadowShurikenAngleDeg", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Dmg Each</label>
  ...
  if (t === "kunai_barrage") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Spread°</label>
        {numInput(turret.kunaiBarrageSpreadDeg, 60, v => update("kunaiBarrageSpreadDeg", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Dmg/Kunai</label>
  ...
  if (t === "smoke_bomb") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Spin Gain×</label>
  ...
  if (t === "exploding_tag") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Trigger Radius</label>
  ...
  if (t === "ultra_form") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Boost Mult</label>
  ...
  if (t === "sage_mode") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Power Mult</label>
        {numInput(turret.sageModePowerMult, 1.8, v => update("sageModePowerMult", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Regen/s</label>
  ...
  if (t === "bankai_release") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Pulse Radius</label>
  ...
  if (t === "susanoo_full") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Shield Rad</label>
  ...
  if (t === "titan_shift") return (
    <div className="grid grid-cols-4 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Pulse Dmg</label>
  ...
  if (t === "summon_toad") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Slam Radius</label>
  ...
  if (t === "summon_snake") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Hold (s)</label>
  ...
  if (t === "summon_slug") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Heal/s</label>
  ...
  if (t === "summon_eagle") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Dive Radius</label>
  ...
  if (t === "summon_clones") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Clones</label>
        {numInput(turret.summonClonesCount, 8, v => update("summonClonesCount", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Dmg/Clone</label>
  ...
  if (t === "wind_god_fist") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Launch Force</label>
  ...
  if (t === "laser_scraper") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Dmg/Degree</label>
  ...
  if (t === "heat_smash") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Ignite (s)</label>
  ...
  if (t === "ki_charge_tek") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Boost Mult</label>
  ...
  if (t === "twin_pistols") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Dmg/Shot</label>
        {numInput(turret.twinPistolsDmgPerShot, 18, v => update("twinPistolsDmgPerShot", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Converge px</label>
  ...
  if (t === "time_warp") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[80px]">Rewind (s)</label>
      {numInput(turret.timeWarpRewindSec, 2, v => update("timeWarpRewindSec", v), 0.5)}
    </div>
  );
  if (t === "time_stop") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[80px]">Freeze (s)</label>
      {numInput(turret.timeStopDurationSec, 1.5, v => update("timeStopDurationSec", v), 0.25)}
    </div>
  );
  if (t === "time_loop") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[80px]">Loop Delay (s)</label>
  ...
  if (t === "time_acceleration") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Decay Mult</label>
  ...
  if (t === "age_drain") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[85px]">Drain Frac/s</label>
  ...
  if (t === "minazuki_heal") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Heal/s</label>
  ...
  if (t === "senbonzakura_kageyoshi") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Waves</label>
        {numInput(turret.senbonzakuraKageyoshiWaves, 3, v => update("senbonzakuraKageyoshiWaves", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Dmg/Wave</label>
  ...
  if (t === "hierro") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Dmg Reduction</label>
  ...
  if (t === "descorrer") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Pull Radius</label>
  ...
  if (t === "lanza_del_relampago") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Explosion Rad</label>
  ...
  if (t === "santa_teresa") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Wave Width</label>
  ...
  if (t === "kido_hado_63") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Paralysis (s)</label>
  ...
  if (t === "kido_hado_90") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Trap (s)</label>
  ...
  if (t === "kido_bakudo_61") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[70px]">Lock (s)</label>
  ...
  if (t === "tsukuyomi") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[80px]">Inversion (s)</label>
  ...
  if (t === "amaterasu_mark") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Mark (s)</label>
        {numInput(turret.amaterasuMarkDurationSec, 10, v => update("amaterasuMarkDurationSec", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Trigger Dmg</label>
  ...
  if (t === "izanami") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[70px]">Loop (s)</label>
      {numInput(turret.izanamiLoopSec, 2, v => update("izanamiLoopSec", v), 0.5)}
    </div>
  );
  if (t === "sharingan_lock") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[75px]">Mirror (s)</label>
      {numInput(turret.sharinganLockSec, 2.5, v => update("sharinganLockSec", v), 0.5)}
    </div>
  );
  if (t === "crow_genjutsu") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[80px]">Chaos (s)</label>
  ...
  if (t === "susanoo_itachi") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Seal (s)</label>
  ...
  if (t === "summon_ryuchi") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Venom/s</label>
  ...
  if (t === "summon_myoboku") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Oil Damage</label>
        {numInput(turret.summonMyobokuOilDmg, 50, v => update("summonMyobokuOilDmg", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[80px]">Boost (s)</label>
  ...
  if (t === "summon_garuda") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Wind Radius</label>
  ...
  if (t === "summon_enma") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Reach (cm)</label>
  ...
  if (t === "summon_gamaken") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Spin Arc°</label>
  ...
  if (t === "edo_tensei") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[80px]">HP Fraction</label>
  ...
  if (t === "cosmic_power") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Atk Reduction</label>
        {numInput(turret.cosmicPowerAtkReduction, 0.75, v => update("cosmicPowerAtkReduction", v), 0.05)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Range Boost</label>
  ...
  if (t === "mirror_world") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Offset (cm)</label>
  ...
  if (t === "perfect_mirage") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[80px]">Invisible (s)</label>
      {numInput(turret.perfectMirageDurationSec, 2.5, v => update("perfectMirageDurationSec", v), 0.5)}
    </div>
  );
  if (t === "broken_reality") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[85px]">Scatter Radius</label>
  ...
  if (t === "echo_image") return (
    <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Decoy HP</label>
  ...
  if (t === "genjutsu_veil") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Drift/tick (cm)</label>
  ...
  if (t === "false_flag") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[80px]">Swap Duration</label>
      {numInput(turret.falseFlagDurationSec, 5, v => update("falseFlagDurationSec", v), 0.5)}
    </div>
  );
  if (t === "mind_fracture") return (
    <div className="flex items-center gap-1.5">
      <label className="text-[11px] text-faint min-w-[80px]">Duration (s)</label>
  ...
  if (t === "spread_bey") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Vectors</label>
        {numInput(turret.spreadBeyCount, 5, v => update("spreadBeyCount", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Arc Half°</label>
        {numInput(turret.spreadBeyArcHalfDeg, 30, v => update("spreadBeyArcHalfDeg", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Dmg/vector</label>
  ...
  if (t === "railbey") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Speed×</label>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Pierce Dmg</label>
  ...
  if (t === "minigun_bey") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Pulses</label>
        {numInput(turret.minigunBeyPulses, 12, v => update("minigunBeyPulses", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Interval (ms)</label>
        {numInput(turret.minigunBeyIntervalMs, 60, v => update("minigunBeyIntervalMs", v), 10)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Dmg/pulse</label>
  ...
  if (t === "heat_seeker_bey") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Ram Speed</label>
        {numInput(turret.heatSeekerBeySpeed, 600, v => update("heatSeekerBeySpeed", v), 50)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Impact Dmg</label>
  ...
  if (t === "bomb_bey") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Fuse (s)</label>
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Damage</label>
  ...
  if (t === "shield_bey") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Retaliation Dmg</label>
        {numInput(turret.shieldBeyRetaliationDmg, 80, v => update("shieldBeyRetaliationDmg", v), 5)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Burst Radius</label>
  ...
  if (t === "turbo_bey") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Spin Boost</label>
  ...
  if (t === "cannon_bey") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Launch Force</label>
  ...
  if (t === "gravity_flip") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[70px]">Repel Force</label>
  ...
  if (t === "magnet_bey") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Chase Force</label>
  ...
  if (t === "bounce_storm") return (
    <div className="grid grid-cols-2 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[75px]">Recoil Mult</label>
  ...
  if (t === "boomerang_path") return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[60px]">Speed °/s</label>
  ...
  if (t === "teleport_dash") return (
    <div className="grid grid-cols-3 gap-2">
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[55px]">Blinks</label>
        {numInput(turret.teleportDashCount, 3, v => update("teleportDashCount", v), 1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Interval (s)</label>
        {numInput(turret.teleportDashIntervalSec, 0.4, v => update("teleportDashIntervalSec", v), 0.1)}
      </div>
      <div className="flex items-center gap-1.5">
        <label className="text-[11px] text-faint min-w-[65px]">Blink Radius</label>
  ...
  return (
    ...
    <div className="flex flex-col gap-4">
      <div className="flex justify-between items-center">
        ...
        <button onClick={add} disabled={items.length >= 8} className={cn("py-[5px] px-[14px] text-white border-none rounded-md text-xs font-medium cursor-pointer bg-theme-red transition-opacity", items.length >= 8 && "opacity-40")}>
          + Add Turret
        </button>
      </div>
        ...
        <div key={turret.id ?? idx} className="bg-bg3 rounded-xl p-4 border border-border">
          ...
          <div className="flex justify-between items-center mb-3">
            <div className="flex items-center gap-2">
              ...
              {turret.behaviorId && (
                <span className="text-[10px] font-semibold py-[2px] px-[7px] rounded-full bg-purple-10 text-theme-purple border border-purple-33">
            ...
            <div className="flex gap-1 flex-wrap">
              {FIRE_PATTERNS.map(p => (
                <button key={p.value} onClick={() => update(turret.id, "firePattern", p.value)}
                  className={cn("py-[2px] px-2 rounded text-[10px] cursor-pointer border transition-colors", (turret.firePattern ?? "nearest") === p.value ? "bg-theme-red text-white border-theme-red" : "bg-transparent text-theme-muted border-border-c hover:border-theme-red")}>
                  {p.label}
                </button>
              ))}
            </div>
              ...
              return (
                <div key={field}>
                  ...
                  <input type="range"
                    ...
                    value={display}
                    onChange={e => update(turret.id, field, pxUnit ? Math.round(+e.target.value * PX_PER_CM_BASE) : +e.target.value)} className="w-full"
                  />
                </div>
              );
            })}
          ...
          <div className="mt-3 grid grid-cols-2 gap-2.5">
            ...
            <div>
              ...
              <textarea
                ...
                rows={2}
                className="w-full bg-bg2 border border-border text-text rounded-md py-1 px-2 text-[11px] font-mono box-border resize-y"
              />
            </div>
          </div>
