...
export function Countdown({ status, timer, show }: CountdownProps) {
  ...
  return (
    <div
      aria-live="polite"
      className={`absolute inset-0 flex items-center justify-center pointer-events-none z-[80] [transition:background_200ms] ${flash ? "bg-[rgba(255,200,60,0.18)]" : "bg-transparent"}`}
    >
      <div
