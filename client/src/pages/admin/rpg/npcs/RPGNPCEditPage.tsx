  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setBattleConfig(d.battleConfig ?? null);
        ...
        setCatchRadius(d.catchRadius ?? "");
        setCatchEventId(d.catchEventId ?? "");
        ...
        <div className={CARD + " space-y-4 flex-1 max-w-2xl"}>
          ...
          <section className="space-y-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-500 mt-1">Face card shown in dialogue boxes. PNG or animated GIF.</p>
              <div className="mt-2 flex items-center gap-3">
                {portraitUrl
          ...
          <section className="space-y-2">
            ...
            <p className="text-[10px] text-gray-500">If set, this NPC chases the player. When within range, the catch event fires (e.g. Grandpa in the dojo).</p>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button onClick={handleDelete} className={BTN_DANGER}>Delete NPC</button>
          </div>
        </div>
        ...
        <div className="sticky top-6 flex-shrink-0 w-[210px]">
          <div className="bg-gray-900 border border-gray-700 rounded-xl p-4 space-y-3">
            ...
            <div className="space-y-1 text-[11px] text-gray-500 border-t border-gray-800 pt-2">
              ...
              {defaultDialogueId && <div><span className="text-gray-400">Dialogue:</span> <span className="font-mono text-[10px] text-blue-300">{defaultDialogueId}</span></div>}
            </div>
          </div>
        </div>
      </div>
