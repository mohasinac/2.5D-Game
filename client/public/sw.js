...
const CACHE_NAME = 'beyblade-v2';
const IS_DEV = self.location.hostname === 'localhost' || self.location.hostname === '127.0.0.1';

// ── Dev mode: self-destruct and reload all clients ────────────────────────────
if (IS_DEV) {
  ...
  // Pass ALL requests straight to the network — no caching in dev
  // (returning without calling event.respondWith lets the browser handle normally)
