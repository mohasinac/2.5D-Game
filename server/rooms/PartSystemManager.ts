...
export class PartSystemManager {
  ...
  private getAllPartsArray(parts: ResolvedPartBundle): Array<{ statModifiers?: import("../../shared/types/beybladeSystem").StatModifier[] }> {
    const arr = [];
  ...
  private resolveSpinInjectionConfig(core: CorePart, activeConfig: string) {
    if (activeConfig) {
      ...
      if (cfg?.overrides?.spinInjection) {
        return { ...core.spinInjection, ...cfg.overrides.spinInjection } as import("../../shared/types/beybladeSystem").SpinInjectionConfig;
      }
    }
  ...
  private resolveCounterRotationConfig(core: CorePart, activeConfig: string) {
    if (activeConfig) {
      ...
      if (cfg?.overrides?.counterRotation) {
        return { ...core.counterRotation, ...cfg.overrides.counterRotation } as import("../../shared/types/beybladeSystem").CounterRotationConfig;
      }
    }
